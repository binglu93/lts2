...
UDP="https://raw.githubusercontent.com/binglu93/lts2/main/"
# install udp-custom
echo downloading udp-custom
wget -O /etc/udp/udp-custom "${UDP}SYSTEM/udp-custom-linux-amd64"
echo downloading default config
wget -O /etc/udp/config.json "${UDP}SYSTEM/config.json"

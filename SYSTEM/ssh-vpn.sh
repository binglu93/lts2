...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/binglu93/lts2/main/SYSTEM/proxy3.js"
...
# Ganti Banner
wget -O /etc/julak.txt "https://raw.githubusercontent.com/binglu93/lts2/main/SYSTEM/julak.txt"

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/binglu93/lts2/main/SYSTEM/bbr.sh && chmod +x bbr.sh && ./bbr.sh

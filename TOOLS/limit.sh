#!/bin/bash
#Script Install Limit Ip /quota

cd
wget -q -O /usr/local/sbin/quota "https://raw.githubusercontent.com/binglu93/lts2/main/TOOLS/quota"
...
sed -i 's/\r//' limit-ip
clear
wget -q -O /usr/bin/limit-ip-ssh "https://raw.githubusercontent.com/binglu93/lts2/main/TOOLS/limit/limit-ip-ssh"
chmod +x /usr/bin/*
cd /usr/bin

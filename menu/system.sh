...
function domain() {
    ...
    install_slowdns() {
        local script_url="https://raw.githubusercontent.com/binglu93/lts2/refs/heads/main/SLOWDNS/installsl.sh"
...
case $opt in
01 |1) clear ; domain ;; 
02 |2) clear ; nano /etc/banner.txt && chmod +x /etc/banner.txt ;; 
03 |3) clear ; m-theme ;; 
04 |4) clear ; coremenu ;; 
...
10 |10) clear ; wget -q https://github.com/binglu93/lts2/raw/refs/heads/main/install-ulang-vps && bash install-ulang-vps ;; 
11 |11) clear ; del-exp ;;
00 |0) clear ; menu ;; 

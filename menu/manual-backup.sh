...
cp -r /etc/banner /root/backup/banner.txt &> /dev/null
cp -r /etc/julak /var/lib/julak &> /dev/null
cd /root
...
◈ DOMAIN  : ${domain}
◈ Tanggal : ${date}
◈ Version   : v.2.0 Original 
◈ Built By  : @JulakBantur 
================================= 
➣ How To Restore ?
➣ Use SFTP
➣ Go to /root
...
echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e " ${ORANGE}  🍀 POWERED BY @JulakBantur 🍀  ${NC}"
echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" 
...
echo -e " ${PURPLE}  Script Premium By  JULAK BANTUR${NC}"
echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
exit 0
fi
echo -e "${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"

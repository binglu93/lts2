...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/binglu93/lts2/refs/heads/main/WEBSOCKET/ws-dropbear
chmod +x /usr/local/bin/ws-dropbear

# Installing Service
cat > /etc/systemd/system/ws-nontls.service << END
[Unit]
Description=Python Proxy Mod By Julak
...
wget -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/binglu93/lts2/refs/heads/main/WEBSOCKET/ws-ovpn.py
...
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/binglu93/lts2/refs/heads/main/WEBSOCKET/ws-stunnel
